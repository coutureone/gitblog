...
My personal blog([About Me](https://github.com/coutureone/gitblog/issues/282)) using issues and GitHub Actions (随意转载，无需署名)
...
if __name__ == "__main__":
    ...
    parser.add_argument("G_T", help="G_T")
    parser.add_argument("repo_name", help="repo_name")
    parser.add_argument(
        "--issue_number", help="issue_number", default=None, required=False
    )
    options = parser.parse_args()
    main(options.G_T, options.repo_name, options.issue_number)
